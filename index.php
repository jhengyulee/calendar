    ...
    <style>
        *{
        ...
        body{
            ...
            background:url(../calendar/pics/wood03.jpg) no-repeat;
    ...
    <main>
        ...
        <div class="select">
            <form action="index.php" method="GET">
                ...
                <input type="button" value="今天的月份" name="button" onclick="location.href='index.php'">
            </form>
        </div>
        ...
        <div class="nav">
            <span>
            <a href="index.php?year=<?=$preYear;?>&month=<?=$preMonth;?>"><i class="fa-solid fa-caret-left"></i></a>
            </span>
            <span>
                <a href=""><?=$year;?>年</a>
            </span>
            ...
            <span>
                <a href="index.php?year=<?=$nextYear;?>&month=<?=$nextMonth;?>"><i class="fa-solid fa-caret-right"></i></a>
            </span>
        </div>
            <!--月份切換-->
            <?php
